  ...
  const skillCategories = [
    {
      ...
      skills: ["Java", "TypeScript", "JavaScript", "Python", "C", "HTML5", "CSS3", "Assembly RISC-V"]
    },
    {
      icon: Database,
      title: "Frameworks & Libraries",
      skills: ["React.js", "React Native", "Node.js", "Next.js", "Express.js", "JUnit", "Vitest", "Supertest", "Tailwind CSS"]
    },
    {
      icon: Settings,
